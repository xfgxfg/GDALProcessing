...
{
    public partial class UnCompressionForm : Form
    {
        public UnCompressionForm()
        {
            InitializeComponent();
        }
        ...
        {
            UnCompressionForm form = (UnCompressionForm)Control.FromHandle(pData);
        ...
        { 
            ...
            try
            {
                ...
                foreach (ListViewItem item in this.listViewImage.Items)
                {
                    ...
                    //去掉文件名中的.tar.gz
                    string sFilePathWithOutName = Path.GetDirectoryName(sFile);
                    //MessageBox.Show(sFilePathWithOutName);
                    string subFolder = Path.GetFileNameWithoutExtension(Path.GetFileNameWithoutExtension(sFile));
                    string sUPath = clsWinrar.unCompressRAR(sFilePathWithOutName + "\\" + subFolder, sFilePathWithOutName, sFile);
